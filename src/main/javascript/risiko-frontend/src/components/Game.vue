<template>
  <v-container fluid>
    <v-row>
      <v-col cols="3" class="actions-menu d-flex flex-column">
        <v-btn color="red" dark @click="showObiettiviDialog=true" class="mb-5">
          Mostra obiettivi
        </v-btn>
        ...
        <div v-if="fasePreparazione">
          ...
          <v-btn text color="red" :disabled="rinforziConsentiti !== totaleRinforzi" @click="inviaRinforzi">Piazza rinforzi</v-btn>
        </div>
      </v-col>
      <v-col cols="9">
...
export default {
  name: "Game",
  components: {ObiettiviDialog, Board},
  data() {
    return {

<template>
  <div>
    <v-banner class="text-h5 text-center mb-5" color="primary" dark>Informazioni sulla partita</v-banner>

    <v-row>
      <!-- Obiettivi -->
      <v-col class="d-flex align-center flex-column" cols="6">
        <span class="text-subtitle-2">OBIETTIVI</span>
        <v-btn class="mb-5" color="primary" rounded width="wrap-content"
               x-large @click="$refs.obiettiviDialog.show()">
